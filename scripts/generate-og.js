...
async function generateOGImages() {
  ...
  console.log(`Viewport: ${OG_WIDTH}x${OG_HEIGHT} (1.91:1 aspect ratio - landscape)`);
  ...
  for (const page of PAGES) {
    try {
      ...
      console.log(`✓ ${page.name}: ${OG_WIDTH}x${OG_HEIGHT} -> ${pngPath}`);
  ...
  console.log('\nNext step: Convert PNG to WebP with:');
